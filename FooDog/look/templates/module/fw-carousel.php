...
<article class="post-wrap post-slider is-light-text post-carousel is-background-post" style="background-image: url(<?php echo esc_url( $look_ruby_featured_attachment[0] ); ?>)">
		<div class="is-table">
